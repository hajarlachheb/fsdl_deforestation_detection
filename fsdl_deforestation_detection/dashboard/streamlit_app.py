...
sys.path.append("fsdl_deforestation_detection/fsdl_deforestation_detection/dashboard/")
from dashboard_utils import load_css
import layouts

PAGES = dict(Playground=layouts.playground, Overview=layouts.overview)
load_css("fsdl_deforestation_detection/fsdl_deforestation_detection/dashboard/style.css")
